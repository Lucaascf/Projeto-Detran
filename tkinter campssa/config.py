...
class ConfigManager:
    ...
    def _load_default_config(self):
        ...
        self.default_config = {
            ...
            "UI_CONFIG": {
                ...
                "padding": {"default": 10, "small": 5, "large": 20, "extra_large": 30},
                "margins": {"default": 10, "small": 5, "large": 20},
            ...
            "SYSTEM_SETTINGS": {
                ...
                "paths": {"temp": "./temp", "logs": "./logs", "data": "./data"},
            },
        }
                ...
                if config_section in self.default_config:
                    ...
                    if current_config.exists():
                        with open(current_config, "r+", encoding="utf-8") as f:
                            ...
                            user_config[config_section] = self.default_config[
                                config_section
                            ].copy()
                            f.seek(0)
                            ...
                            f.truncate()
                    self.logger.info(
                        f"Configuração {config_section} resetada com sucesso"
                    )
            else:
    ...
    def _load_user_config(self):
        ...
        if config_path.exists():
            try:
                ...
                self.logger.error(
                    f"Erro ao carregar configurações do usuário: {str(e)}"
                )
                self._create_default_user_config()
        else:
            self._create_default_user_config()
    ...
    def _create_default_user_config(self):
        ...
        try:
            ...
            self.logger.info(
                f"Criado arquivo de configuração padrão para {self.current_user}"
            )
        except Exception as e:
