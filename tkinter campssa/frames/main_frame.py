...
class MainFrame(Frame):
    ...
    def _init_attributes(self, master, planilhas, file_path, app):
        """Inicializa os atributos da classe."""
        self.current_user = (
            app.get_current_user() if hasattr(app, "get_current_user") else None
        )
    ...
    def create_widgets(self):
        ...
        cadastro_frame = ttk.LabelFrame(
            grid_frame, text=" Cadastro e Gestão ", style="Custom.TLabelframe"
        )
        ...
        marcacao_frame = ttk.LabelFrame(
            grid_frame, text=" Agenda e Marcações ", style="Custom.TLabelframe"
        )
        ...
        financeiro_frame = ttk.LabelFrame(
            grid_frame, text=" Gestão Financeira ", style="Custom.TLabelframe"
        )
        ...
        documentos_frame = ttk.LabelFrame(
            grid_frame, text=" Documentos e Relatórios ", style="Custom.TLabelframe"
        )
        ...
        tools_frame = ttk.LabelFrame(
            grid_frame, text=" Ferramentas ", style="Custom.TLabelframe"
        )
